...
public class SceneManager3 : MonoBehaviour {
    ...
    IEnumerator battle2()
    {
        ...
        BattleManager.instance.addEnemy(0, new Vector2(149, 5), false);
        BattleManager.instance.addEnemy(0, new Vector2(179, 5), false);
        yield return new WaitForSeconds(12);
        BattleManager.instance.addEnemy(0, new Vector2(149, 0), false);
        BattleManager.instance.addEnemy(0, new Vector2(179, 0), false);
        yield return new WaitForSeconds(10);
        BattleManager.instance.addEnemy(0, new Vector2(164, 5), false);
    ...
    IEnumerator battle3()
    {
        ...
        BattleManager.instance.addEnemy(0, new Vector2(238, 0), false);
        BattleManager.instance.addEnemy(1, new Vector2(245, 5), false);
        yield return new WaitForSeconds(12);
        BattleManager.instance.addEnemy(1, new Vector2(230, 5), false);
        BattleManager.instance.addEnemy(0, new Vector2(238, 0), false);
        BattleManager.instance.addEnemy(1, new Vector2(245, 5), false);
    ...
    IEnumerator battle5()
    {
        ...
        BattleManager.instance.addEnemy(1, new Vector2(297, 5), false);
        BattleManager.instance.addEnemy(0, new Vector2(303, 0), false);
        BattleManager.instance.addEnemy(1, new Vector2(314, 5), false);
        yield return new WaitForSeconds(12);
        BattleManager.instance.addEnemy(1, new Vector2(297, 5), false);
        BattleManager.instance.addEnemy(0, new Vector2(303, 0), false);
        BattleManager.instance.addEnemy(1, new Vector2(314, 5), false);
        yield return new WaitForSeconds(12);
        BattleManager.instance.addEnemy(0, new Vector2(297, 5), false);
        BattleManager.instance.addEnemy(0, new Vector2(303, 0), false);
        BattleManager.instance.addEnemy(0, new Vector2(314, 5), true);
        autoEvent = true;
    }
