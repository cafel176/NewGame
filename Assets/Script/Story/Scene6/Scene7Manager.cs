...
public class Scene7Manager : MonoBehaviour {
    ...
    private void FixedUpdate()
    {
        if (gamePanel.showFinish && (Application.platform == RuntimePlatform.Android ? Input.GetTouch(0).phase == TouchPhase.Began : Input.GetKeyDown(KeyCode.Z)))
        {
            ...
            switch (gameManager.instance.now)
            {
                ...
                case 21:
                    if (!gameManager.instance.ach.Contains("07"))
                        gameManager.instance.getAchievemrnt(7);
    ...
    IEnumerator battle0()
    {
        ...
        BattleManager.instance.addEnemy(4, new Vector2(42, 0), false);
        BattleManager.instance.addEnemy(3, new Vector2(20, 0), false);
        yield return new WaitForSeconds(10);
        BattleManager.instance.addEnemy(3, new Vector2(42, 0), false);
        BattleManager.instance.addEnemy(4, new Vector2(20, 0), false);
        yield return new WaitForSeconds(10);
        BattleManager.instance.addEnemy(4, new Vector2(42, 0), false);
        BattleManager.instance.addEnemy(5, new Vector2(30, 0), false);
        BattleManager.instance.addEnemy(4, new Vector2(20, 0), true);
    }
    ...
    IEnumerator battle1()
    {
        ...
        BattleManager.instance.addEnemy(4, new Vector2(97, -1), false);
        BattleManager.instance.addEnemy(4, new Vector2(77, -1), false);
        yield return new WaitForSeconds(10);
        BattleManager.instance.addEnemy(5, new Vector2(97, -1), false);
        yield return new WaitForSeconds(5);
        BattleManager.instance.addEnemy(5, new Vector2(77, -1), false);
        yield return new WaitForSeconds(5);
        BattleManager.instance.addEnemy(5, new Vector2(77, -1), false);
        BattleManager.instance.addEnemy(5, new Vector2(97, -1), false);
        yield return new WaitForSeconds(10);
        BattleManager.instance.addEnemy(5, new Vector2(77, -1), false);
        BattleManager.instance.addEnemy(4, new Vector2(90, -1), false);
        BattleManager.instance.addEnemy(5, new Vector2(97, -1), true);
    }
    ...
    IEnumerator battle2()
    {
        ...
        BattleManager.instance.addEnemy(3, new Vector2(149, 0), false);
        BattleManager.instance.addEnemy(4, new Vector2(179, 0), false);
        yield return new WaitForSeconds(10);
        BattleManager.instance.addEnemy(4, new Vector2(164, 5), false);
        BattleManager.instance.addEnemy(5, new Vector2(149, 5), false);
    ...
    IEnumerator battle3()
    {
        ...
        BattleManager.instance.addEnemy(5, new Vector2(238, 0), false);
        ...
        BattleManager.instance.addEnemy(4, new Vector2(245, 5), false);
        yield return new WaitForSeconds(12);
        BattleManager.instance.addEnemy(5, new Vector2(230, 5), false);
        BattleManager.instance.addEnemy(4, new Vector2(238, 0), false);
        BattleManager.instance.addEnemy(5, new Vector2(245, 5), true);
    }
