...
public class Scene6Manager : MonoBehaviour {
    ...
    IEnumerator battle0()
    {
        ...
        yield return new WaitForSeconds(10);
        BattleManager.instance.addEnemy(4, new Vector2(42, 0), false);
        BattleManager.instance.addEnemy(2, new Vector2(30, 0), false);
    ...
    IEnumerator battle2()
    {
        ...
        BattleManager.instance.addEnemy(4, new Vector2(179, 5), false);
        yield return new WaitForSeconds(12);
        BattleManager.instance.addEnemy(3, new Vector2(149, 0), false);
        BattleManager.instance.addEnemy(5, new Vector2(179, 0), false);
        yield return new WaitForSeconds(12);
        BattleManager.instance.addEnemy(5, new Vector2(164, 5), false);
        BattleManager.instance.addEnemy(1, new Vector2(149, 5), false);
        BattleManager.instance.addEnemy(1, new Vector2(179, 5), true);
    }
    ...
    IEnumerator battle3()
    {
        ...
        BattleManager.instance.addEnemy(5, new Vector2(238, 0), false);
        BattleManager.instance.addEnemy(2, new Vector2(245, 5), false);
        yield return new WaitForSeconds(12);
        BattleManager.instance.addEnemy(1, new Vector2(230, 5), false);
        BattleManager.instance.addEnemy(5, new Vector2(238, 0), false);
        BattleManager.instance.addEnemy(1, new Vector2(245, 5), true);
    }
